...
// use crate::lib::bencode::from_bytes;
use crate::util::librqbit_core::{
    id20::Id20, lengths::Lengths, peer_id::generate_peer_id, speed_estimator::SpeedEstimator,
    torrent_metainfo::TorrentMetaV1Info,
};
use crate::util::{buffers::ByteString, rqbit_bencode::from_bytes, sha1w::Sha1System};
use log::{debug, info, warn};
use parking_lot::Mutex;
use reqwest::Url;
// use crate::util::sha1w::Sha1;
...
impl TorrentManager {
    fn start<P: AsRef<Path>>(
        ...
        let initial_check_results = spawner.spawn_block_in_place(|| {
            FileOps::<Sha1System>::new(&info, &files, &lengths)
