...
///
/// Example: torrent_helper/0.0.0 (1234567890ab)
pub const CREATED_BY_DEFAULT: &str = concat!(
  "torrent_helper/",
...
pub const HELP_MESSAGE: &str = "Print help message.";
...
pub const PROGRESS_STYLE: &str = "{spinner:.green} ⟪{elapsed_precise}⟫ ⟦{wide_bar:.cyan}⟧ \
                                         {binary_bytes}/{binary_total_bytes} \
                                         ⟨{binary_bytes_per_sec}, {eta}⟩";

pub const VERSION: &str = concat!("v", env!("CARGO_PKG_VERSION"));

pub const VERSION_MESSAGE: &str = "Print version number.";
